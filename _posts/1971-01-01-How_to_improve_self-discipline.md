...
>本文系转载，这是[知乎原文链接](https://www.zhihu.com/question/19888447/answer/1930799480401293785)
...
为了验证这个想法，笔者作为一个从小被严重[ADHD](https://zhida.zhihu.com/search?content_id=738191429&content_type=Answer&match_order=1&q=ADHD&zhida_source=entity)和自控问题困扰的人，花费了从小学到博士的十几年岁月，经历了无数试错，思考和验证，才逐渐摸索出这篇文章将要介绍的两代自控技术。
...
**最后，一个小提示：在阅读过程中，你很可能会产生各种各样的疑问（比如读到[神圣座位原理](https://zhida.zhihu.com/search?content_id=738191429&content_type=Answer&match_order=1&q=神圣座位原理&zhida_source=entity)时，可能会想“如果作弊怎么办”、“如果反而不愿坐上去怎么办”），请千万不要着急，通常下一节就会解答这些疑问。而第一代方法的许多局限性，也会在第13节后引入的第二代方法中讨论与解决。总之，请慢慢读，千万别着急：）**
...
![img](https://pic1.zhimg.com/80/v2-d34e6a417ac5e72381b0d246d85e8f03_1440w.webp?source=2c26e567)
...
**为了解决这个问题，让我们引入更加精妙的第二个核心原理：“[下必为例](https://zhida.zhihu.com/search?content_id=738191429&content_type=Answer&match_order=1&q=下必为例&zhida_source=entity)”原理。**
...
**此时，就要轮到我们第三个核心原理：“[线性时延原理](https://zhida.zhihu.com/search?content_id=738191429&content_type=Answer&match_order=1&q=线性时延原理&zhida_source=entity)”。**
...
5. 1. 判定整个主任务链立即失败，清空所有当前已累积的节点记录，下一次只能从 #1 重新开始；
...
![img](https://picx.zhimg.com/80/v2-db1ca85ac2e8b67e948968bd7a07dbda_1440w.webp?source=2c26e567)
...
![img](https://pic1.zhimg.com/80/v2-0e23089b64d5969f5ff6af5de1da9819_1440w.webp?source=2c26e567)
...
![img](https://pica.zhimg.com/80/v2-0e286216ab0650168af5a8ea3a5ef8d6_1440w.webp?source=2c26e567)
...
> 所有将本文改编成视频，漫画，推文等产生的所有收益归改编者所有，本文作者分文不取。
